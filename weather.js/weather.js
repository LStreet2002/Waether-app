...
button.addEventListener('click', async function fetcher() {
    var response = await fetch('https://api.openweathermap.org/data/2.5/weather?q=' + inputcity.value + '&APPID=f7b2e4417287ec1a07110967f2048dcc');
    ...
    temperature.innerHTML = temperatureReading
